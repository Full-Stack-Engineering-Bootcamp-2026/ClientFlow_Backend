...
public class PatientDaoImpl implements PatientDao {
    ...
    public Patient save(Patient patient) {
        ...
        try {
            ...
            log.error("Database error while saving patient: {}", ex.getMessage());
    ...
    public boolean existsByMobile(String mobile) {
        ...
        try {
            ...
            log.error("Database error while checking patient mobile: {}", ex.getMessage());
    ...
    public Optional<Patient> findByMobile(String mobile) {
        ...
        try {
            ...
            log.error("Database error while fetching patient by mobile: {}", ex.getMessage());
...
public List<Patient> searchPatients(String keyword) {
    ...
    try {
        ...
        log.error("Database error while searching patients: {}", ex.getMessage());
